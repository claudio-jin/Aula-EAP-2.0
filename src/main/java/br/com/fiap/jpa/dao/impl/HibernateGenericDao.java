...
public abstract class HibernateGenericDao <T extends Serializable, PK extends Serializable > implements GenericDao<T, PK>{
	...
	public void salvar(Serializable instancia, EntityManager entityManager) {
		entityManager.persist(instancia);
	}

	public void atualizar(Serializable instancia, EntityManager entityManager) {
		entityManager.merge(instancia);
	}

	public void remover(Serializable id, EntityManager entityManager) {
		T instancia = this.obterPorId(id, entityManager);
		
		entityManager.remove(instancia);
	}

	public T obterPorId(Serializable id, EntityManager entityManager) {
